<template>
    <div>
        <div v-if="explore" class="container-fluid relative px-3">
            <div class="layout-specing">
                ...
                <div class="grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                    <div v-for="product in filteredData" :key="product.id" class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all  duration-500 hover:-mt-2 h-fit">
        ...
        <div v-else-if="explores" id="grid" class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
            <div v-for="product in filteredData.slice(0, 4)" :key="product.id"
        ...
        <div v-else>
            <div class="md:flex justify-between items-center">
                <div class="md:w-4/12 md:text-start text-center">
                    <h3 class="text-lg font-semibold">Explore Items</h3>
                </div>
                <div class="md:w-8/12 md:text-end text-center">
                    <div class="filters-group-wrap">
                        <div class="filters-group">
                            <router-link to="/explore"
                                class="btn btn-link text-[16px] font-medium text-slate-400 hover:text-slate-900 dark:hover:text-slate-300 after:bg-slate-900 dark:after:bg-slate-300 duration-500">More
                                Items <i class="uil uil-arrow-right"></i></router-link>
                        </div>
                    </div>
                </div>
            </div><!--end grid-->

            <div id="grid" class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-6 gap-4 mx-2">
                <div v-for="product in filteredData.slice(0, 8)" :key="product.id"
                    class="group relative overflow-hidden p-2 rounded-lg bg-white dark:bg-slate-900 border border-gray-100 dark:border-gray-800 hover:shadow-md dark:shadow-md hover:dark:shadow-gray-700 transition-all duration-500 hover:-mt-2 h-fit">
                    <div class="relative overflow-hidden">
                        <div class="relative overflow-hidden rounded-lg">
            ...
            product.remaining?.minutes + " : " + product.remaining?.seconds }}</small>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="my-3">
                            <router-link :to="{ name: 'item-detail', params: { id: product.id}}"
                                class="font-semibold hover:text-violet-600">{{ product.title
                                }}</router-link>
                        </div>
    ...
    data() {
        return {
            products: [
                ...
                {
                    id: 13,
                    mainimage: require('../assets/images/items/7.gif'),
                    image: require('../assets/images/items/5.gif'),
                    name: '@Princess',
                    title: 'Gloam Druid',
                    price: '3.5 ETH',
                ...
                {
                    id: 15,
                    mainimage: require('../assets/images/items/11.jpg'),
                    image: require('../assets/images/items/2.gif'),
                    name: '@FunnyGuy',
                    title: 'Wolf-Cult Vanguard',
                    price: '3.5 ETH',
